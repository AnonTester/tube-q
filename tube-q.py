...
<head>
  ...
  <style>
    ...
    textarea,input[type="text"] { width: calc(100% - 16px); max-height:60px; padding:8px; border-radius:6px; border:1px solid #ddd; box-sizing:border-box; white-space: pre; overflow-wrap: normal; overflow: auto}
